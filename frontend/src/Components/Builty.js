...
import { GetBuiltyByDate, DeleteBuilty } from "../Redux/Slice/BuiltySlice";
import BuiltyModal from "./BuiltyModal";

export default function Builty(props) {
    ...
    }, [dateFilter.fromDate, dateFilter.toDate, dispatch]);
